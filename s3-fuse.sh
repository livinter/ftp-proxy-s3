...
/usr/local/bin/s3fs $FTP_BUCKET /home/aws/s3bucket/testuser -o allow_other -o mp_umask="0022" -o nonempty -o iam_role="$IAM_ROLE" -o stat_cache_expire=600 #-d -d -f -o f2 -o curldbg
/usr/local/users.sh
